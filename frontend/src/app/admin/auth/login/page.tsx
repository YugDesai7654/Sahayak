    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-saffron rounded-2xl flex items-center justify-center text-2xl text-white mx-auto mb-4">⚙️</div>
          <h1 className="text-3xl font-extrabold text-white">Admin Portal</h1>
          <p className="text-gray-400 mt-1">Sahayak Administration System</p>
        </div>
        <form onSubmit={handleSubmit} className="card p-8 space-y-5">
          ...
          <div><label className="label">Email</label><input type="email" value={email} onChange={e => setEmail(e.target.value)} className="input-field" placeholder="admin@sahayak.gov.in" required /></div>
          ...
          <button type="submit" disabled={loading} className="w-full bg-saffron text-white px-6 py-3 rounded-xl font-semibold hover:opacity-90 transition disabled:opacity-50">
